      ...
      <div class="right">
        <div class="link">
          <a-tooltip placement="left">
            <template slot="title"> GitHub（开发中...） </template>
    ...
    <div class="bottom">
      ...
      <div>
        <a-tooltip placement="top" v-if="data.points >= 0">
          <template slot="title"> 新手 </template>
        ...
        <a-tooltip placement="top" v-if="data.points >= 100">
          <template slot="title"> 麒麟儿 </template>
        ...
        <a-tooltip placement="top" v-if="data.points >= 300">
          <template slot="title"> 三好学生 </template>
        ...
        <a-tooltip placement="top" v-if="data.points >= 600">
          <template slot="title"> 技术贡献者 </template>
        ...
        <a-tooltip placement="top" v-if="data.points >= 1000">
          <template slot="title"> 优秀作者 </template>
        ...
        <a-tooltip placement="top" v-if="data.points >= 1500">
          <template slot="title"> 共建者 </template>
