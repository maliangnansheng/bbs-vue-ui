<template>
  <div id="nan-sheng-value" :style="$store.state.collapsed ? 'padding: 10px 10px 0 10px;' : 'padding: 50px 50px 20px 50px;'">
    <div class="markdown-body">
      ...
      <br/>
      <h2>南生值</h2>
      <p>在南生论坛里我们会使用 <strong>南生值</strong> 来计算一个南友的累计贡献值，累计贡献值的目的是为了更好地回馈优质的用户，同时也借由他们生产的优质内容帮助到更多的南友们。您可以在您的个人主页上看到自己的南生值。</p>
      <h3>南生值的价值</h3>
      <ol>
      ...
      <table>
        ...
        <tr>
          ...
          <td>99</td>
          <td>
            <img src="@/assets/img/level/badge-Lv1.svg" alt="" /> 新手
          </td>
          <td>基础功能</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>自动推荐至首页，南生论坛优秀作者，其他功能开发中</td>
        </tr>
        <tr>
          <td>
          ...
          <td>维护标签，南生论坛共建者，<span style="color: red;">免费获取南生论坛最新源码</span></td>
        </tr>
        </tbody>
      </table>
      <h3>刷南生值的惩罚</h3>
      <p>一经发现某一用户通过机器等手段刷点赞、阅读等数据，恶意提高自己的南生值，南生论坛作者在核实后会给予惩罚，<span style="color: red;">南生值归 0，撤销所有权限及身份。</span></p>
    </div>
  </div>
</template>
