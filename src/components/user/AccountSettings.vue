  ...
  <div id="account-settings" v-if="!spinning">
    ...
    <div class="settings-content">
      <section>
        ...
        <div>
          <a-popconfirm v-if="user.phone" :title="$t('common.unBindPhoneTitle')" @confirm="toggleBindPhone()" class="operation">
      ...
      <section>
        ...
        <div>
          <a-popconfirm v-if="user.email" :title="$t('common.unBindEmailTitle')" @confirm="toggleBindEmail()" class="operation">
            <a-button type="danger" size="small">
              {{ $t('common.unBind') }}
            </a-button>
          </a-popconfirm>
          <a-button v-else @click="toggleBindEmail" type="primary" size="small">{{ $t('common.bind') }} </a-button>
        </div>
      </section>
      <a-divider />
      <section>
    ...
    <bind-phone :title="user.phone" :visible="bindPhoneVisible" @refresh="refresh" @closeModal="() => (bindPhoneVisible = false)" />
    <bind-email :title="user.email" :visible="bindEmailVisible" @refresh="refresh" @closeModal="() => (bindEmailVisible = false)" />
    <change-password :visible="changePasswordVisible" @refresh="refresh" @closeModal="() => (changePasswordVisible = false)" />
  </div>
</template>
